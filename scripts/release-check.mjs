...
const steps = [
  ...
  { label: "RBAC contract", cmd: "npm", args: ["run", "check:rbac"] },
  { label: "Price RBAC contract", cmd: "npm", args: ["run", "check:price-rbac"] },
  { label: "VeriFactu SIF identity contract", cmd: "npm", args: ["run", "check:verifactu-sif"] },
