...
| F6 | MEDIO | Sesiones/rate-limit sin bloqueo ni estado compartido | 🟡 **MITIGADO** — race de sesiones resuelta con mutex de escritura (rama, pendiente desplegar); rate-limit sigue en memoria (aceptable con 1 instancia) |
...
### F6 · Sesiones y rate-limit — MITIGADO 🟡 (en rama, pendiente desplegar)
