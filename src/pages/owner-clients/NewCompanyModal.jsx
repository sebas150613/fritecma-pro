...
export function NewCompanyModal({ open, onOpenChange, plans, ownerEmail, onCreated }) {
  ...
  const isBillable = form.commercial_status === "activa" || form.commercial_status === "pendiente_pago";
  ...
  const submit = async () => {
    ...
    if (isBillable && (!form.legal_name.trim() || !form.tax_id.trim())) {
      setError("La razón social y el NIF/CIF son obligatorios para empresas activas o facturables.");
      return;
    }
    ...
    const payload = {
      ...
      // Facturación reutiliza la identidad fiscal y el contacto principal: se puede
      // afinar por separado más adelante desde la ficha de empresa si hace falta.
      billing_fiscal_name: form.legal_name.trim() || null,
      billing_tax_id: form.tax_id.trim() || null,
      billing_email: form.billing_email.trim() || null,
      billing_contact_name: form.commercial_contact_name.trim() || null,
      billing_phone: form.commercial_contact_phone.trim() || null,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] rounded-2xl p-0 gap-0 overflow-hidden flex flex-col">
        <DialogHeader className="px-6 pt-6 pb-2 shrink-0">
          <DialogTitle className="text-xl font-semibold tracking-tight">Nueva empresa</DialogTitle>
          <p className="text-sm text-muted-foreground font-normal">
            Los datos fiscales y el resto de campos comerciales se pueden completar o ajustar más
            adelante desde la ficha de la empresa.
          </p>
        </DialogHeader>
        ...
        <div className="max-h-[calc(90vh-8rem)] overflow-y-auto px-6">
          ...
          >
            ...
            {isBillable ? (
              <div>
                {sectionTitle("Datos fiscales y facturación")}
                <p className="text-xs text-muted-foreground -mt-2 mb-3">
                  Obligatorios porque el estado comercial elegido es facturable.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="sm:col-span-2">
            ...
            <div>
              {sectionTitle("Administrador inicial")}
            ...
            <Collapsible open={showMore} onOpenChange={setShowMore}>
              ...
              <CollapsibleContent className="pt-4">
                ...
                <p className="text-xs text-muted-foreground mt-3">
                  Cargo, idioma, canal preferido, referencias internas y otros datos de CRM se pueden
                  añadir después desde la ficha de la empresa.
                </p>
              </CollapsibleContent>
            </Collapsible>
          </form>
